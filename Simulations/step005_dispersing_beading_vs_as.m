...
legend({'Ktotal', 'Kaniso', 'Kiso', 'Kmicro'}, 'Location','northwest')
...
subplot(1, 5, 2)
plot(AS, mean(AKi, 2), 'color', [68 154 217]/255)
hold on
plot(AS, mean(RKi, 2), 'color', [45 11 117]/255)
plot(AS, mean(AKv, 2), 'color', [217 154 68]/255)
plot(AS, mean(RKv, 2), 'color', [117 11 45]/255)
plot(AS, mean(AK, 2), '.')
plot(AS, mean(RK, 2), '.')
xlabel('$$A$$', 'Interpreter', 'latex', 'Interpreter','latex', 'fontsize', 10)
legend({'AKI', 'RKI', 'AKv', 'RKv', 'AK', 'RK'}, 'Location','northwest')


subplot(1, 5, 3)
plot(AS, mean(AKi, 2)./mean(AK, 2), 'color', [68 154 217]/255)
hold on
plot(AS, mean(RKi, 2)./mean(RK, 2), 'color', [45 11 117]/255)
xlabel('$$A$$', 'Interpreter', 'latex', 'Interpreter','latex', 'fontsize', 10)
