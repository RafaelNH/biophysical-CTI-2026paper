...
for whichd = 1:9
    ...
    if Smooth_Gaussian
        if constraints
            save([dinfo(di).savename(1:end-6), 'cti_d_gs_c'], ...
            ...
            save([dinfo(di).savename(1:end-6), 'cti_d_gs'], ...
                'KISO', 'KANISO', 'KINTRA', 'KTOTAL', 'FA', 'MD', 'AD', 'RD', ...
                'MK', 'AK', 'RK', 'MKi', 'AKi', 'RKi', 'MKv', 'RKv', 'AKv',...
                'DTOTAL_pa', 'KTOTAL_pa', 'KANISO_pa', 'KISO_pa', 'KINTRA_pa', 'S0_pa',...
                'MKT', 'AKT', 'RKT', 'MKTv', 'AKTv', 'RKTv', 'MKTi', 'AKTi', 'RKTi', ...
        ...
        if constraints
            save([dinfo(di).savename(1:end-6), 'cti_d_c'], ...
                'KISO', 'KANISO', 'KINTRA', 'KTOTAL', 'FA', 'MD', 'AD', 'RD', ...
                'MK', 'AK', 'RK', 'MKi', 'AKi', 'RKi', 'MKv', 'RKv', 'AKv',...
                'DTOTAL_pa', 'KTOTAL_pa', 'KANISO_pa', 'KISO_pa', 'KINTRA_pa', 'S0_pa',...
                'MKT', 'AKT', 'RKT', 'MKTv', 'AKTv', 'RKTv', 'MKTi', 'AKTi', 'RKTi', ...
            ...
            save([dinfo(di).savename(1:end-6), 'cti_d'], ...
                'KISO', 'KANISO', 'KINTRA', 'KTOTAL', 'FA', 'MD', 'AD', 'RD', ...
                'MK', 'AK', 'RK', 'MKi', 'AKi', 'RKi', 'MKv', 'RKv', 'AKv',...
                'DTOTAL_pa', 'KTOTAL_pa', 'KANISO_pa', 'KISO_pa', 'KINTRA_pa', 'S0_pa',...
                'MKT', 'AKT', 'RKT', 'MKTv', 'AKTv', 'RKTv', 'MKTi', 'AKTi', 'RKTi', ...
